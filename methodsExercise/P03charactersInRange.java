...
public class P03charactersInRange {
    ...
    public static void printCharactersInRange(char symbol1, char symbol2) {
        if (symbol1 < symbol2) {      //започваме от по малкия символ
          for (char symbol = (char)(symbol1 + 1); symbol < symbol2 ; symbol++) {   //започваме от 1вия симвом +1, защото не го включваме
